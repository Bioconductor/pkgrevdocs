...
See [Version Numbering](#versionnum) for specifics to how the release
...
using one of <i class="fab fa-r-project"></i>’s standard specifications. <i
class="fab fa-r-project"></i> ships with the following [standard
licenses](https://www.r-project.org/Licenses/)
