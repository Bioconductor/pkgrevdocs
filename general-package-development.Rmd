...
[_Bioconductor_ packages](https://bioconductor.org/packages/devel/BiocViews.html#___Software) when developing and testing packages to be contributed.
...
See the how-to on [using devel version of Bioconductor]['devel' version] for up-to-date information.
...
Every effort should be made to address any errors, warnings, and notes that
arise during this build or check.


### ERROR, WARNGING, and NOTES {#error-warnging-and-notes}

The [_Bioconductor_](https://bioconductor.org/) team member assigned to review
...
[_Bioconductor_](https://bioconductor.org/) repository. See [data section](#data) for
