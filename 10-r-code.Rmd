...
fits the originally proposed behavior of the generic.
`r BiocStyle::Biocpkg("BiocGenerics")` lists commonly used generics in
Bioconductor. Re-using generics reduces the amount of new generics by
...
potentially cause method name collisions and pollute the methods environment
