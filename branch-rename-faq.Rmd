...
sync'ed to each other (see question above).

    ## rename the branch to devel
...
**Caveat**: From here, the changes need to be 'pushed' to GitHub and the
default branch on GitHub needs to be set manually and the old branch deleted
from GitHub.
...
If you are cloning a repository from `git.bioconductor.org` _after_ the
