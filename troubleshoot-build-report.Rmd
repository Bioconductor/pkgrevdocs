...
Note: `_R_CHECK_SUGGESTS_ONLY_` is only set on the Linux builders and in order
to identify missing dependencies. In order to use this setting, you must have
a `site-library` subfolder in your R home directory.
