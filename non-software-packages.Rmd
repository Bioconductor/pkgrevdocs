...
above Annotation or Experiment data packages except the data is stored
in a provided _Bioconductor_ Microsoft [Azure Data Lakes][]
...
of on in the [Create A Hub Package][] vignette within the [HubPub][] Bioconductor
package.
...
* In an effort to standardize the workflow vignette format, it is strongly
  ...
  [BiocWorkflowTools][]. The following header shows how to use [BiocStyle][] in
  the vignette:  
