...
If data structures differ from similar packages, [_Bioconductor_][] reviewers
will expect some justification as to why. Keep in mind it is always possible to
...
BiocStyle::Biocpkg("BiocStyle")` for formatting.

Some best practices for writing _Bioconductor_ vignettes are detailed in the
following sections.
...
package from other packages in the same area.
